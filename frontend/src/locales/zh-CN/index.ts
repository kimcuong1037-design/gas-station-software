...
export default {
  ...
  reportCenter: {
    ...
    custom: {
      ...
      myTemplates: '我的模板',
      noTemplates: '暂无自定义模板',
      selectPrompt: '请选择左侧模板或创建新模板',
      buildTemplate: '创建报表模板',
      editTemplate: '编辑报表模板',
      preview: '预览',
      deleteConfirm: '确定删除此模板？',
      nameRequired: '请输入模板名称',
      dimensionRequired: '请至少选择一个维度',
      metricRequired: '请至少选择一个指标',
      createSuccess: '模板创建成功',
      updateSuccess: '模板更新成功',
      deleteSuccess: '模板已删除',
    },
    types: {
      dailyOperations: '经营日报',
      monthlyOperations: '经营月报',
      shiftHandover: '交接班报表',
      inspection: '巡检报表',
      inventory: '库存报表',
      custom: '自定义报表',
    ...
    generateSuccess: '报表生成成功',
    exportMvpTip: '导出功能将在后端实现后启用',
    selectAndGenerate: '请选择日期和站点后点击"生成报表"',
    stationDetail: '站点明细',
    shiftDetail: '班次明细',
    kpi: {
      revenue: '营业额',
    ...
    inspection: {
      ...
      rectifiedCount: '已整改数',
      criticalCount: '高危问题数',
      rectificationRate: '整改完成率',
      area: '检查区域',
      description: '问题描述',
      severity: '严重程度',
      discoveredDate: '发现日期',
      daysPending: '待整改天数',
      unresolvedAlert: '以下高/紧急级别问题尚未整改',
      areaDistribution: '区域问题分布',
    },
    inventory: {
      fuelType: '燃料类型',
      inbound: '入库量',
    ...
    charts: {
      fuelBreakdown: '燃料类型占比',
      stationComparison: '站点对比',
      dailyTrend: '日均趋势',
      paymentDistribution: '支付方式分布',
      shiftComparison: '班次对比',
      tankTrend: '罐容比趋势',
    },
    dataSource: {
      operations: '经营数据',
